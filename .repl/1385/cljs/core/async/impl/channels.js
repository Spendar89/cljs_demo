...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t34316 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t34316 = (function (val,box,meta34317){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t34316.cljs$lang$type = true;
cljs.core.async.impl.channels.t34316.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t34316";
cljs.core.async.impl.channels.t34316.cljs$lang$ctorPrWriter = (function (this__15549__auto__,writer__15550__auto__,opt__15551__auto__){return cljs.core._write.call(null,writer__15550__auto__,"cljs.core.async.impl.channels/t34316");
});
cljs.core.async.impl.channels.t34316.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t34316.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34318){var self__ = this;
var _34318__$1 = this;return self__.meta34317;
});
cljs.core.async.impl.channels.t34316.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34318,meta34317__$1){var self__ = this;
var _34318__$1 = this;return (new cljs.core.async.impl.channels.t34316(self__.val,self__.box,meta34317__$1));
});
cljs.core.async.impl.channels.__GT_t34316 = (function __GT_t34316(val__$1,box__$1,meta34317){return (new cljs.core.async.impl.channels.t34316(val__$1,box__$1,meta34317));
});
}
return (new cljs.core.async.impl.channels.t34316(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_34319 = self__.takes.pop();if((taker_34319 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_34319))
{var take_cb_34320 = cljs.core.async.impl.protocols.commit.call(null,taker_34319);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_34320,taker_34319){
return (function (){return take_cb_34320.call(null,null);
});})(take_cb_34320,taker_34319))
);
} else
{}
{
