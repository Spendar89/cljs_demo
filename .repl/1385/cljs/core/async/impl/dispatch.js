...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_34310 = 0;while(true){
var m_34311 = cljs.core.async.impl.dispatch.tasks.pop();if((m_34311 == null))
{} else
{m_34311.call(null);
if((count_34310 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__34312 = (count_34310 + 1);
count_34310 = G__34312;
continue;
}
} else
{}
