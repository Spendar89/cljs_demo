...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_34219 = 0;while(true){
if((i_34219 < arr.length))
{(arr[i_34219] = null);
{
...
{var i_34226 = (self__.level + 1);while(true){
if((i_34226 <= (new_level + 1)))
{(update[i_34226] = self__.header);
{
var G__34227 = (i_34226 + 1);
i_34226 = G__34227;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_34228 = 0;while(true){
if((i_34228 <= self__.level))
{var links_34229 = (update[i_34228]).forward;if(((links_34229[i_34228]) === x__$1))
{(links_34229[i_34228] = (x__$1.forward[i_34228]));
{
var G__34230 = (i_34228 + 1);
i_34228 = G__34230;
continue;
}
} else
{{
var G__34231 = (i_34228 + 1);
i_34228 = G__34231;
continue;
}
}
