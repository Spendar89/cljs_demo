...
{{
var G__34589 = cljs.core.pop.call(null,v__$1);
v__$1 = G__34589;
continue;
}
} else
...
{var pred__34593 = cljs.core._EQ_;var expr__34594 = limit;if(cljs.core.truth_(pred__34593.call(null,1,expr__34594)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__34593.call(null,2,expr__34594)))
...
var G__34596 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__34597 = (limit__$1 - 1);
var G__34598 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__34596;
limit__$1 = G__34597;
parts = G__34598;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___34600 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___34600))
{var replacement_34601 = temp__4124__auto___34600;buffer.append([cljs.core.str(replacement_34601)].join(''));
} else
{buffer.append(ch);
}
{
var G__34602 = (index + 1);
index = G__34602;
continue;
}
}
