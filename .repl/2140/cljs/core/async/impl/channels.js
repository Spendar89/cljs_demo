...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t31873 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t31873 = (function (val,box,meta31874){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t31873.cljs$lang$type = true;
cljs.core.async.impl.channels.t31873.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t31873";
cljs.core.async.impl.channels.t31873.cljs$lang$ctorPrWriter = (function (this__15549__auto__,writer__15550__auto__,opt__15551__auto__){return cljs.core._write.call(null,writer__15550__auto__,"cljs.core.async.impl.channels/t31873");
});
cljs.core.async.impl.channels.t31873.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t31873.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_31875){var self__ = this;
var _31875__$1 = this;return self__.meta31874;
});
cljs.core.async.impl.channels.t31873.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_31875,meta31874__$1){var self__ = this;
var _31875__$1 = this;return (new cljs.core.async.impl.channels.t31873(self__.val,self__.box,meta31874__$1));
});
cljs.core.async.impl.channels.__GT_t31873 = (function __GT_t31873(val__$1,box__$1,meta31874){return (new cljs.core.async.impl.channels.t31873(val__$1,box__$1,meta31874));
});
}
return (new cljs.core.async.impl.channels.t31873(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_31876 = self__.takes.pop();if((taker_31876 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_31876))
{var take_cb_31877 = cljs.core.async.impl.protocols.commit.call(null,taker_31876);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_31877,taker_31876){
return (function (){return take_cb_31877.call(null,null);
});})(take_cb_31877,taker_31876))
);
} else
{}
{
