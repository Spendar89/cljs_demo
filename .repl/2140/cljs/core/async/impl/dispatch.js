...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_31867 = 0;while(true){
var m_31868 = cljs.core.async.impl.dispatch.tasks.pop();if((m_31868 == null))
{} else
{m_31868.call(null);
if((count_31867 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__31869 = (count_31867 + 1);
count_31867 = G__31869;
continue;
}
} else
{}
