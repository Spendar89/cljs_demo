...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_31776 = 0;while(true){
if((i_31776 < arr.length))
{(arr[i_31776] = null);
{
var G__31777 = (i_31776 + 1);
i_31776 = G__31777;
continue;
}
} else
...
{var i_31783 = (self__.level + 1);while(true){
if((i_31783 <= (new_level + 1)))
{(update[i_31783] = self__.header);
{
var G__31784 = (i_31783 + 1);
i_31783 = G__31784;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_31785 = 0;while(true){
if((i_31785 <= self__.level))
{var links_31786 = (update[i_31785]).forward;if(((links_31786[i_31785]) === x__$1))
{(links_31786[i_31785] = (x__$1.forward[i_31785]));
{
var G__31787 = (i_31785 + 1);
i_31785 = G__31787;
continue;
}
} else
{{
var G__31788 = (i_31785 + 1);
i_31785 = G__31788;
continue;
}
}
