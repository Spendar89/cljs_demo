...
{return cljs.core.reduce.call(null,(function (result,p__31994){var vec__31995 = p__31994;var k = cljs.core.nth.call(null,vec__31995,0,null);var v = cljs.core.nth.call(null,vec__31995,1,null);return cljs.core.assoc.call(null,result,k,v);
...
*/
clojure.data.diff_associative_key = (function diff_associative_key(a,b,k){var va = cljs.core.get.call(null,a,k);var vb = cljs.core.get.call(null,b,k);var vec__31997 = clojure.data.diff.call(null,va,vb);var a_STAR_ = cljs.core.nth.call(null,vec__31997,0,null);var b_STAR_ = cljs.core.nth.call(null,vec__31997,1,null);var ab = cljs.core.nth.call(null,vec__31997,2,null);var in_a = cljs.core.contains_QMARK_.call(null,a,k);var in_b = cljs.core.contains_QMARK_.call(null,b,k);var same = (in_a) && (in_b) && ((!((ab == null))) || (((va == null)) && ((vb == null))));return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((in_a) && ((!((a_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,a_STAR_], true, false):null),(((in_b) && ((!((b_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,b_STAR_], true, false):null),((same)?new cljs.core.PersistentArrayMap.fromArray([k,ab], true, false):null)], null);
});
/**
...
clojure.data.EqualityPartition = (function (){var obj31999 = {};return obj31999;
})();
...
clojure.data.Diff = (function (){var obj32001 = {};return obj32001;
})();
...
(clojure.data.equality_partition["_"] = (function (x){if((function (){var G__32002 = x;if(G__32002)
{var bit__15632__auto__ = (G__32002.cljs$lang$protocol_mask$partition0$ & 1024);if((bit__15632__auto__) || (G__32002.cljs$core$IMap$))
{return true;
} else
{if((!G__32002.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__32002);
} else
{return false;
}
}
...
{if((function (){var G__32003 = x;if(G__32003)
{var bit__15632__auto__ = (G__32003.cljs$lang$protocol_mask$partition0$ & 4096);if((bit__15632__auto__) || (G__32003.cljs$core$ISet$))
{return true;
} else
{if((!G__32003.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__32003);
} else
{return false;
}
}
...
{if((function (){var G__32004 = x;if(G__32004)
{var bit__15632__auto__ = (G__32004.cljs$lang$protocol_mask$partition0$ & 16777216);if((bit__15632__auto__) || (G__32004.cljs$core$ISequential$))
{return true;
} else
{if((!G__32004.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__32004);
} else
{return false;
}
}
...
(clojure.data.diff_similar["_"] = (function (a,b){return (function (){var G__32005 = clojure.data.equality_partition.call(null,a);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"map","map",1014012110),G__32005))
{return clojure.data.diff_associative;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"sequential","sequential",849892465),G__32005))
{return clojure.data.diff_sequential;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"set","set",1014018004),G__32005))
{return clojure.data.diff_set;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"atom","atom",1016908995),G__32005))
