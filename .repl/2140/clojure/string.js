...
{{
var G__32036 = cljs.core.pop.call(null,v__$1);
v__$1 = G__32036;
continue;
}
} else
...
{var pred__32040 = cljs.core._EQ_;var expr__32041 = limit;if(cljs.core.truth_(pred__32040.call(null,1,expr__32041)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__32040.call(null,2,expr__32041)))
...
var G__32043 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__32044 = (limit__$1 - 1);
var G__32045 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__32043;
limit__$1 = G__32044;
parts = G__32045;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___32047 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___32047))
{var replacement_32048 = temp__4124__auto___32047;buffer.append([cljs.core.str(replacement_32048)].join(''));
} else
{buffer.append(ch);
}
{
