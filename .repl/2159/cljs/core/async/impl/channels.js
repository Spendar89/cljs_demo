...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t36795 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t36795 = (function (val,box,meta36796){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t36795.cljs$lang$type = true;
cljs.core.async.impl.channels.t36795.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t36795";
cljs.core.async.impl.channels.t36795.cljs$lang$ctorPrWriter = (function (this__15549__auto__,writer__15550__auto__,opt__15551__auto__){return cljs.core._write.call(null,writer__15550__auto__,"cljs.core.async.impl.channels/t36795");
});
cljs.core.async.impl.channels.t36795.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t36795.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36797){var self__ = this;
var _36797__$1 = this;return self__.meta36796;
});
cljs.core.async.impl.channels.t36795.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36797,meta36796__$1){var self__ = this;
var _36797__$1 = this;return (new cljs.core.async.impl.channels.t36795(self__.val,self__.box,meta36796__$1));
});
cljs.core.async.impl.channels.__GT_t36795 = (function __GT_t36795(val__$1,box__$1,meta36796){return (new cljs.core.async.impl.channels.t36795(val__$1,box__$1,meta36796));
});
}
return (new cljs.core.async.impl.channels.t36795(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_36798 = self__.takes.pop();if((taker_36798 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_36798))
{var take_cb_36799 = cljs.core.async.impl.protocols.commit.call(null,taker_36798);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_36799,taker_36798){
return (function (){return take_cb_36799.call(null,null);
});})(take_cb_36799,taker_36798))
);
} else
{}
{
