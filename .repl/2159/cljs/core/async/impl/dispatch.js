...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_36789 = 0;while(true){
var m_36790 = cljs.core.async.impl.dispatch.tasks.pop();if((m_36790 == null))
{} else
{m_36790.call(null);
if((count_36789 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__36791 = (count_36789 + 1);
count_36789 = G__36791;
continue;
}
} else
{}
