...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_36698 = 0;while(true){
if((i_36698 < arr.length))
{(arr[i_36698] = null);
{
var G__36699 = (i_36698 + 1);
i_36698 = G__36699;
continue;
}
} else
...
{var i_36705 = (self__.level + 1);while(true){
if((i_36705 <= (new_level + 1)))
{(update[i_36705] = self__.header);
{
var G__36706 = (i_36705 + 1);
i_36705 = G__36706;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_36707 = 0;while(true){
if((i_36707 <= self__.level))
{var links_36708 = (update[i_36707]).forward;if(((links_36708[i_36707]) === x__$1))
{(links_36708[i_36707] = (x__$1.forward[i_36707]));
{
