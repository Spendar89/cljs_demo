...
{return cljs.core.reduce.call(null,(function (result,p__36916){var vec__36917 = p__36916;var k = cljs.core.nth.call(null,vec__36917,0,null);var v = cljs.core.nth.call(null,vec__36917,1,null);return cljs.core.assoc.call(null,result,k,v);
...
clojure.data.EqualityPartition = (function (){var obj36921 = {};return obj36921;
})();
...
clojure.data.Diff = (function (){var obj36923 = {};return obj36923;
})();
...
(clojure.data.equality_partition["_"] = (function (x){if((function (){var G__36924 = x;if(G__36924)
{var bit__15632__auto__ = (G__36924.cljs$lang$protocol_mask$partition0$ & 1024);if((bit__15632__auto__) || (G__36924.cljs$core$IMap$))
{return true;
} else
{if((!G__36924.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__36924);
} else
{return false;
}
}
...
{if((function (){var G__36925 = x;if(G__36925)
{var bit__15632__auto__ = (G__36925.cljs$lang$protocol_mask$partition0$ & 4096);if((bit__15632__auto__) || (G__36925.cljs$core$ISet$))
{return true;
} else
{if((!G__36925.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__36925);
} else
{return false;
}
}
...
{if((function (){var G__36926 = x;if(G__36926)
{var bit__15632__auto__ = (G__36926.cljs$lang$protocol_mask$partition0$ & 16777216);if((bit__15632__auto__) || (G__36926.cljs$core$ISequential$))
{return true;
} else
{if((!G__36926.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__36926);
} else
{return false;
}
}
...
(clojure.data.diff_similar["_"] = (function (a,b){return (function (){var G__36927 = clojure.data.equality_partition.call(null,a);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"map","map",1014012110),G__36927))
{return clojure.data.diff_associative;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"sequential","sequential",849892465),G__36927))
{return clojure.data.diff_sequential;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"set","set",1014018004),G__36927))
{return clojure.data.diff_set;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"atom","atom",1016908995),G__36927))
