...
{{
var G__36958 = cljs.core.pop.call(null,v__$1);
v__$1 = G__36958;
continue;
}
} else
...
{var pred__36962 = cljs.core._EQ_;var expr__36963 = limit;if(cljs.core.truth_(pred__36962.call(null,1,expr__36963)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__36962.call(null,2,expr__36963)))
...
var G__36965 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__36966 = (limit__$1 - 1);
var G__36967 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__36965;
limit__$1 = G__36966;
parts = G__36967;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___36969 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___36969))
{var replacement_36970 = temp__4124__auto___36969;buffer.append([cljs.core.str(replacement_36970)].join(''));
} else
{buffer.append(ch);
}
{
var G__36971 = (index + 1);
index = G__36971;
continue;
}
}
