...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t39731 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t39731 = (function (val,box,meta39732){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t39731.cljs$lang$type = true;
cljs.core.async.impl.channels.t39731.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t39731";
cljs.core.async.impl.channels.t39731.cljs$lang$ctorPrWriter = (function (this__15594__auto__,writer__15595__auto__,opt__15596__auto__){return cljs.core._write.call(null,writer__15595__auto__,"cljs.core.async.impl.channels/t39731");
});
cljs.core.async.impl.channels.t39731.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t39731.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39733){var self__ = this;
var _39733__$1 = this;return self__.meta39732;
});
cljs.core.async.impl.channels.t39731.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39733,meta39732__$1){var self__ = this;
var _39733__$1 = this;return (new cljs.core.async.impl.channels.t39731(self__.val,self__.box,meta39732__$1));
});
cljs.core.async.impl.channels.__GT_t39731 = (function __GT_t39731(val__$1,box__$1,meta39732){return (new cljs.core.async.impl.channels.t39731(val__$1,box__$1,meta39732));
});
}
return (new cljs.core.async.impl.channels.t39731(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__15597__auto__,writer__15598__auto__,opts__15599__auto__){return cljs.core._write.call(null,writer__15598__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__15594__auto__,writer__15595__auto__,opt__15596__auto__){return cljs.core._write.call(null,writer__15595__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_39734 = self__.takes.pop();if((taker_39734 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_39734))
{var take_cb_39735 = cljs.core.async.impl.protocols.commit.call(null,taker_39734);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_39735,taker_39734){
return (function (){return take_cb_39735.call(null,null);
});})(take_cb_39735,taker_39734))
);
} else
{}
{
