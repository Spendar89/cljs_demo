...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_39725 = 0;while(true){
var m_39726 = cljs.core.async.impl.dispatch.tasks.pop();if((m_39726 == null))
{} else
{m_39726.call(null);
if((count_39725 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__39727 = (count_39725 + 1);
count_39725 = G__39727;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__15015__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__15015__auto__)
