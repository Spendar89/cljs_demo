...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__15594__auto__,writer__15595__auto__,opt__15596__auto__){return cljs.core._write.call(null,writer__15595__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_39634 = 0;while(true){
if((i_39634 < arr.length))
{(arr[i_39634] = null);
{
var G__39635 = (i_39634 + 1);
i_39634 = G__39635;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__15594__auto__,writer__15595__auto__,opt__15596__auto__){return cljs.core._write.call(null,writer__15595__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_39641 = (self__.level + 1);while(true){
if((i_39641 <= (new_level + 1)))
{(update[i_39641] = self__.header);
{
var G__39642 = (i_39641 + 1);
i_39641 = G__39642;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_39643 = 0;while(true){
if((i_39643 <= self__.level))
{var links_39644 = (update[i_39643]).forward;if(((links_39644[i_39643]) === x__$1))
{(links_39644[i_39643] = (x__$1.forward[i_39643]));
{
var G__39645 = (i_39643 + 1);
i_39643 = G__39645;
continue;
}
} else
{{
var G__39646 = (i_39643 + 1);
i_39643 = G__39646;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__15027__auto__ = (cljs.core.truth_((function (){var and__15015__auto__ = me;if(cljs.core.truth_(and__15015__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__15015__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__15027__auto__))
