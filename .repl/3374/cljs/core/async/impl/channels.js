...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t44510 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t44510 = (function (val,box,meta44511){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t44510.cljs$lang$type = true;
cljs.core.async.impl.channels.t44510.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t44510";
cljs.core.async.impl.channels.t44510.cljs$lang$ctorPrWriter = (function (this__15549__auto__,writer__15550__auto__,opt__15551__auto__){return cljs.core._write.call(null,writer__15550__auto__,"cljs.core.async.impl.channels/t44510");
});
cljs.core.async.impl.channels.t44510.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t44510.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_44512){var self__ = this;
var _44512__$1 = this;return self__.meta44511;
});
cljs.core.async.impl.channels.t44510.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_44512,meta44511__$1){var self__ = this;
var _44512__$1 = this;return (new cljs.core.async.impl.channels.t44510(self__.val,self__.box,meta44511__$1));
});
cljs.core.async.impl.channels.__GT_t44510 = (function __GT_t44510(val__$1,box__$1,meta44511){return (new cljs.core.async.impl.channels.t44510(val__$1,box__$1,meta44511));
});
}
return (new cljs.core.async.impl.channels.t44510(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_44513 = self__.takes.pop();if((taker_44513 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_44513))
{var take_cb_44514 = cljs.core.async.impl.protocols.commit.call(null,taker_44513);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_44514,taker_44513){
return (function (){return take_cb_44514.call(null,null);
});})(take_cb_44514,taker_44513))
);
} else
{}
{
