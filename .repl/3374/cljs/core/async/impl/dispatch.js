...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_44504 = 0;while(true){
var m_44505 = cljs.core.async.impl.dispatch.tasks.pop();if((m_44505 == null))
{} else
{m_44505.call(null);
if((count_44504 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__44506 = (count_44504 + 1);
count_44504 = G__44506;
continue;
}
} else
{}
