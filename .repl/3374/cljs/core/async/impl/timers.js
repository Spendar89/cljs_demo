...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_44413 = 0;while(true){
if((i_44413 < arr.length))
{(arr[i_44413] = null);
{
var G__44414 = (i_44413 + 1);
i_44413 = G__44414;
continue;
}
} else
...
{var i_44420 = (self__.level + 1);while(true){
if((i_44420 <= (new_level + 1)))
{(update[i_44420] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_44422 = 0;while(true){
if((i_44422 <= self__.level))
{var links_44423 = (update[i_44422]).forward;if(((links_44423[i_44422]) === x__$1))
{(links_44423[i_44422] = (x__$1.forward[i_44422]));
{
