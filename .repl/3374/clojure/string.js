...
{{
var G__41734 = cljs.core.pop.call(null,v__$1);
v__$1 = G__41734;
continue;
}
} else
...
{var pred__41738 = cljs.core._EQ_;var expr__41739 = limit;if(cljs.core.truth_(pred__41738.call(null,1,expr__41739)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__41738.call(null,2,expr__41739)))
...
var G__41741 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__41742 = (limit__$1 - 1);
var G__41743 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__41741;
limit__$1 = G__41742;
parts = G__41743;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___41745 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___41745))
{var replacement_41746 = temp__4124__auto___41745;buffer.append([cljs.core.str(replacement_41746)].join(''));
} else
{buffer.append(ch);
}
{
var G__41747 = (index + 1);
index = G__41747;
continue;
}
}
