...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t21558 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t21558 = (function (val,box,meta21559){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t21558.cljs$lang$type = true;
cljs.core.async.impl.channels.t21558.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t21558";
cljs.core.async.impl.channels.t21558.cljs$lang$ctorPrWriter = (function (this__10073__auto__,writer__10074__auto__,opt__10075__auto__){return cljs.core._write.call(null,writer__10074__auto__,"cljs.core.async.impl.channels/t21558");
});
cljs.core.async.impl.channels.t21558.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t21558.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21560){var self__ = this;
var _21560__$1 = this;return self__.meta21559;
});
cljs.core.async.impl.channels.t21558.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21560,meta21559__$1){var self__ = this;
var _21560__$1 = this;return (new cljs.core.async.impl.channels.t21558(self__.val,self__.box,meta21559__$1));
});
cljs.core.async.impl.channels.__GT_t21558 = (function __GT_t21558(val__$1,box__$1,meta21559){return (new cljs.core.async.impl.channels.t21558(val__$1,box__$1,meta21559));
});
}
return (new cljs.core.async.impl.channels.t21558(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__10076__auto__,writer__10077__auto__,opts__10078__auto__){return cljs.core._write.call(null,writer__10077__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__10073__auto__,writer__10074__auto__,opt__10075__auto__){return cljs.core._write.call(null,writer__10074__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_21561 = self__.takes.pop();if((taker_21561 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_21561))
{var take_cb_21562 = cljs.core.async.impl.protocols.commit.call(null,taker_21561);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_21562,taker_21561){
return (function (){return take_cb_21562.call(null,null);
});})(take_cb_21562,taker_21561))
);
} else
{}
{
