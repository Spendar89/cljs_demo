...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_21552 = 0;while(true){
var m_21553 = cljs.core.async.impl.dispatch.tasks.pop();if((m_21553 == null))
{} else
{m_21553.call(null);
if((count_21552 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__21554 = (count_21552 + 1);
count_21552 = G__21554;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__9494__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__9494__auto__)
