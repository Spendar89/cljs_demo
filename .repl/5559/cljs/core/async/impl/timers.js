...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__10073__auto__,writer__10074__auto__,opt__10075__auto__){return cljs.core._write.call(null,writer__10074__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_21461 = 0;while(true){
if((i_21461 < arr.length))
{(arr[i_21461] = null);
{
var G__21462 = (i_21461 + 1);
i_21461 = G__21462;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__10073__auto__,writer__10074__auto__,opt__10075__auto__){return cljs.core._write.call(null,writer__10074__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_21468 = (self__.level + 1);while(true){
if((i_21468 <= (new_level + 1)))
{(update[i_21468] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_21470 = 0;while(true){
if((i_21470 <= self__.level))
{var links_21471 = (update[i_21470]).forward;if(((links_21471[i_21470]) === x__$1))
{(links_21471[i_21470] = (x__$1.forward[i_21470]));
{
var G__21472 = (i_21470 + 1);
i_21470 = G__21472;
continue;
}
} else
{{
var G__21473 = (i_21470 + 1);
i_21470 = G__21473;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__9506__auto__ = (cljs.core.truth_((function (){var and__9494__auto__ = me;if(cljs.core.truth_(and__9494__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__9494__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__9506__auto__))
