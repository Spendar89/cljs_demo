...
{{
var G__23392 = cljs.core.pop.call(null,v__$1);
v__$1 = G__23392;
continue;
}
} else
...
{var pred__23396 = cljs.core._EQ_;var expr__23397 = limit;if(cljs.core.truth_(pred__23396.call(null,1,expr__23397)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__23396.call(null,2,expr__23397)))
...
var G__23399 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__23400 = (limit__$1 - 1);
var G__23401 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__23399;
limit__$1 = G__23400;
parts = G__23401;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___23403 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___23403))
{var replacement_23404 = temp__4124__auto___23403;buffer.append([cljs.core.str(replacement_23404)].join(''));
} else
{buffer.append(ch);
}
{
var G__23405 = (index + 1);
index = G__23405;
continue;
}
}
