...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t39692 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t39692 = (function (val,box,meta39693){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t39692.cljs$lang$type = true;
cljs.core.async.impl.channels.t39692.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t39692";
cljs.core.async.impl.channels.t39692.cljs$lang$ctorPrWriter = (function (this__15148__auto__,writer__15149__auto__,opt__15150__auto__){return cljs.core._write.call(null,writer__15149__auto__,"cljs.core.async.impl.channels/t39692");
});
cljs.core.async.impl.channels.t39692.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t39692.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39694){var self__ = this;
var _39694__$1 = this;return self__.meta39693;
});
cljs.core.async.impl.channels.t39692.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39694,meta39693__$1){var self__ = this;
var _39694__$1 = this;return (new cljs.core.async.impl.channels.t39692(self__.val,self__.box,meta39693__$1));
});
cljs.core.async.impl.channels.__GT_t39692 = (function __GT_t39692(val__$1,box__$1,meta39693){return (new cljs.core.async.impl.channels.t39692(val__$1,box__$1,meta39693));
});
}
return (new cljs.core.async.impl.channels.t39692(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_39695 = self__.takes.pop();if((taker_39695 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_39695))
{var take_cb_39696 = cljs.core.async.impl.protocols.commit.call(null,taker_39695);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_39696,taker_39695){
return (function (){return take_cb_39696.call(null,null);
});})(take_cb_39696,taker_39695))
);
} else
{}
{
