...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_39686 = 0;while(true){
var m_39687 = cljs.core.async.impl.dispatch.tasks.pop();if((m_39687 == null))
{} else
{m_39687.call(null);
if((count_39686 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__39688 = (count_39686 + 1);
count_39686 = G__39688;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__14569__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__14569__auto__)
