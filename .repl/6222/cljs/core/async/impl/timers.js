...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_39595 = 0;while(true){
if((i_39595 < arr.length))
{(arr[i_39595] = null);
{
var G__39596 = (i_39595 + 1);
i_39595 = G__39596;
continue;
}
} else
...
{var i_39602 = (self__.level + 1);while(true){
if((i_39602 <= (new_level + 1)))
{(update[i_39602] = self__.header);
{
var G__39603 = (i_39602 + 1);
i_39602 = G__39603;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_39604 = 0;while(true){
if((i_39604 <= self__.level))
{var links_39605 = (update[i_39604]).forward;if(((links_39605[i_39604]) === x__$1))
{(links_39605[i_39604] = (x__$1.forward[i_39604]));
{
var G__39606 = (i_39604 + 1);
i_39604 = G__39606;
continue;
}
} else
{{
var G__39607 = (i_39604 + 1);
i_39604 = G__39607;
continue;
}
}
