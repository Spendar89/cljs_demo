...
{{
var G__36642 = cljs.core.pop.call(null,v__$1);
v__$1 = G__36642;
continue;
}
} else
...
{var pred__36646 = cljs.core._EQ_;var expr__36647 = limit;if(cljs.core.truth_(pred__36646.call(null,1,expr__36647)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__36646.call(null,2,expr__36647)))
...
var G__36649 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__36650 = (limit__$1 - 1);
var G__36651 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__36649;
limit__$1 = G__36650;
parts = G__36651;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___36653 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___36653))
{var replacement_36654 = temp__4124__auto___36653;buffer.append([cljs.core.str(replacement_36654)].join(''));
} else
{buffer.append(ch);
}
{
var G__36655 = (index + 1);
index = G__36655;
continue;
}
}
