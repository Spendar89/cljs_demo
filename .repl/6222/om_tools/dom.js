...
*/
om_tools.dom.opt_key_case = (function opt_key_case(attr){if(cljs.core.truth_((function (){var or__14581__auto__ = (cljs.core.count.call(null,attr) < 5);if(or__14581__auto__)
...
*/
om_tools.dom.opt_key_alias = (function opt_key_alias(opt){var G__40481 = opt;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"for","for",1014005819),G__40481))
{return new cljs.core.Keyword(null,"htmlFor","htmlFor",2249940112);
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"class","class",1108647146),G__40481))
...
*/
om_tools.dom.format_opts = (function format_opts(opts){return cljs.core.clj__GT_js.call(null,cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__40484){var vec__40485 = p__40484;var k = cljs.core.nth.call(null,vec__40485,0,null);var v = cljs.core.nth.call(null,vec__40485,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [om_tools.dom.format_opt_key.call(null,k),om_tools.dom.format_opt_val.call(null,v)], null);
}),opts)));
});
...
om_tools.dom.element = (function element(ctor,opts,children){var vec__40487 = om_tools.dom.element_args.call(null,opts,children);var opts__$1 = cljs.core.nth.call(null,vec__40487,0,null);var children__$1 = cljs.core.nth.call(null,vec__40487,1,null);return cljs.core.apply.call(null,ctor,cljs.core.flatten.call(null,cljs.core.cons.call(null,opts__$1,children__$1)));
});
