...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t29202 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t29202 = (function (val,box,meta29203){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t29202.cljs$lang$type = true;
cljs.core.async.impl.channels.t29202.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t29202";
cljs.core.async.impl.channels.t29202.cljs$lang$ctorPrWriter = (function (this__15549__auto__,writer__15550__auto__,opt__15551__auto__){return cljs.core._write.call(null,writer__15550__auto__,"cljs.core.async.impl.channels/t29202");
});
cljs.core.async.impl.channels.t29202.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t29202.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29204){var self__ = this;
var _29204__$1 = this;return self__.meta29203;
});
cljs.core.async.impl.channels.t29202.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29204,meta29203__$1){var self__ = this;
var _29204__$1 = this;return (new cljs.core.async.impl.channels.t29202(self__.val,self__.box,meta29203__$1));
});
cljs.core.async.impl.channels.__GT_t29202 = (function __GT_t29202(val__$1,box__$1,meta29203){return (new cljs.core.async.impl.channels.t29202(val__$1,box__$1,meta29203));
});
}
return (new cljs.core.async.impl.channels.t29202(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_29205 = self__.takes.pop();if((taker_29205 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_29205))
{var take_cb_29206 = cljs.core.async.impl.protocols.commit.call(null,taker_29205);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_29206,taker_29205){
return (function (){return take_cb_29206.call(null,null);
});})(take_cb_29206,taker_29205))
);
} else
{}
{
