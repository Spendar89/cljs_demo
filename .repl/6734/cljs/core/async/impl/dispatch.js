...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_29196 = 0;while(true){
var m_29197 = cljs.core.async.impl.dispatch.tasks.pop();if((m_29197 == null))
{} else
{m_29197.call(null);
if((count_29196 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__29198 = (count_29196 + 1);
count_29196 = G__29198;
continue;
}
} else
{}
