...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_29105 = 0;while(true){
if((i_29105 < arr.length))
{(arr[i_29105] = null);
{
var G__29106 = (i_29105 + 1);
i_29105 = G__29106;
continue;
}
} else
...
{var i_29112 = (self__.level + 1);while(true){
if((i_29112 <= (new_level + 1)))
{(update[i_29112] = self__.header);
{
var G__29113 = (i_29112 + 1);
i_29112 = G__29113;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_29114 = 0;while(true){
if((i_29114 <= self__.level))
{var links_29115 = (update[i_29114]).forward;if(((links_29115[i_29114]) === x__$1))
{(links_29115[i_29114] = (x__$1.forward[i_29114]));
{
var G__29116 = (i_29114 + 1);
i_29114 = G__29116;
continue;
}
} else
{{
var G__29117 = (i_29114 + 1);
i_29114 = G__29117;
continue;
}
}
