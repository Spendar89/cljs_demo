...
{{
var G__26426 = cljs.core.pop.call(null,v__$1);
v__$1 = G__26426;
continue;
}
} else
...
{var pred__26430 = cljs.core._EQ_;var expr__26431 = limit;if(cljs.core.truth_(pred__26430.call(null,1,expr__26431)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__26430.call(null,2,expr__26431)))
...
var G__26433 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__26434 = (limit__$1 - 1);
var G__26435 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__26433;
limit__$1 = G__26434;
parts = G__26435;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___26437 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___26437))
{var replacement_26438 = temp__4124__auto___26437;buffer.append([cljs.core.str(replacement_26438)].join(''));
} else
{buffer.append(ch);
}
{
var G__26439 = (index + 1);
index = G__26439;
continue;
}
}
