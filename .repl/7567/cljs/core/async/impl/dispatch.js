...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_40488 = 0;while(true){
var m_40489 = cljs.core.async.impl.dispatch.tasks.pop();if((m_40489 == null))
{} else
{m_40489.call(null);
if((count_40488 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__40490 = (count_40488 + 1);
count_40488 = G__40490;
continue;
}
} else
{}
