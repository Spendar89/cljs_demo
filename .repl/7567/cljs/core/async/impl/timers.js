...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__15148__auto__,writer__15149__auto__,opt__15150__auto__){return cljs.core._write.call(null,writer__15149__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_40397 = 0;while(true){
if((i_40397 < arr.length))
{(arr[i_40397] = null);
{
var G__40398 = (i_40397 + 1);
i_40397 = G__40398;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__15148__auto__,writer__15149__auto__,opt__15150__auto__){return cljs.core._write.call(null,writer__15149__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_40404 = (self__.level + 1);while(true){
if((i_40404 <= (new_level + 1)))
{(update[i_40404] = self__.header);
{
var G__40405 = (i_40404 + 1);
i_40404 = G__40405;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_40406 = 0;while(true){
if((i_40406 <= self__.level))
{var links_40407 = (update[i_40406]).forward;if(((links_40407[i_40406]) === x__$1))
{(links_40407[i_40406] = (x__$1.forward[i_40406]));
{
var G__40408 = (i_40406 + 1);
i_40406 = G__40408;
continue;
}
} else
{{
var G__40409 = (i_40406 + 1);
i_40406 = G__40409;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__14581__auto__ = (cljs.core.truth_((function (){var and__14569__auto__ = me;if(cljs.core.truth_(and__14569__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__14569__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__14581__auto__))
