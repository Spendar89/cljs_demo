...
{{
var G__37444 = cljs.core.pop.call(null,v__$1);
v__$1 = G__37444;
continue;
}
} else
...
{var pred__37448 = cljs.core._EQ_;var expr__37449 = limit;if(cljs.core.truth_(pred__37448.call(null,1,expr__37449)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__37448.call(null,2,expr__37449)))
...
var G__37451 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__37452 = (limit__$1 - 1);
var G__37453 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__37451;
limit__$1 = G__37452;
parts = G__37453;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___37455 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___37455))
{var replacement_37456 = temp__4124__auto___37455;buffer.append([cljs.core.str(replacement_37456)].join(''));
} else
{buffer.append(ch);
}
{
var G__37457 = (index + 1);
index = G__37457;
continue;
}
}
