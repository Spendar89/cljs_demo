...
*/
om_tools.dom.opt_key_alias = (function opt_key_alias(opt){var G__41283 = opt;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"for","for",1014005819),G__41283))
{return new cljs.core.Keyword(null,"htmlFor","htmlFor",2249940112);
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"class","class",1108647146),G__41283))
...
*/
om_tools.dom.format_opts = (function format_opts(opts){return cljs.core.clj__GT_js.call(null,cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__41286){var vec__41287 = p__41286;var k = cljs.core.nth.call(null,vec__41287,0,null);var v = cljs.core.nth.call(null,vec__41287,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [om_tools.dom.format_opt_key.call(null,k),om_tools.dom.format_opt_val.call(null,v)], null);
}),opts)));
});
...
om_tools.dom.element = (function element(ctor,opts,children){var vec__41289 = om_tools.dom.element_args.call(null,opts,children);var opts__$1 = cljs.core.nth.call(null,vec__41289,0,null);var children__$1 = cljs.core.nth.call(null,vec__41289,1,null);return cljs.core.apply.call(null,ctor,cljs.core.flatten.call(null,cljs.core.cons.call(null,opts__$1,children__$1)));
});
