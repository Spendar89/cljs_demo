...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_46930 = 0;while(true){
var m_46931 = cljs.core.async.impl.dispatch.tasks.pop();if((m_46931 == null))
{} else
{m_46931.call(null);
if((count_46930 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__46932 = (count_46930 + 1);
count_46930 = G__46932;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__15075__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__15075__auto__)
