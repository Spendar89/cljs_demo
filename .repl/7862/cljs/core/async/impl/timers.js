...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__15654__auto__,writer__15655__auto__,opt__15656__auto__){return cljs.core._write.call(null,writer__15655__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_46839 = 0;while(true){
if((i_46839 < arr.length))
{(arr[i_46839] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__15654__auto__,writer__15655__auto__,opt__15656__auto__){return cljs.core._write.call(null,writer__15655__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_46846 = (self__.level + 1);while(true){
if((i_46846 <= (new_level + 1)))
{(update[i_46846] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_46848 = 0;while(true){
if((i_46848 <= self__.level))
{var links_46849 = (update[i_46848]).forward;if(((links_46849[i_46848]) === x__$1))
{(links_46849[i_46848] = (x__$1.forward[i_46848]));
{
var G__46850 = (i_46848 + 1);
i_46848 = G__46850;
continue;
}
} else
{{
var G__46851 = (i_46848 + 1);
i_46848 = G__46851;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__15087__auto__ = (cljs.core.truth_((function (){var and__15075__auto__ = me;if(cljs.core.truth_(and__15075__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__15075__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__15087__auto__))
