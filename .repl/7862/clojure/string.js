...
{{
var G__44270 = cljs.core.pop.call(null,v__$1);
v__$1 = G__44270;
continue;
}
} else
...
{var pred__44274 = cljs.core._EQ_;var expr__44275 = limit;if(cljs.core.truth_(pred__44274.call(null,1,expr__44275)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__44274.call(null,2,expr__44275)))
...
var G__44277 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__44278 = (limit__$1 - 1);
var G__44279 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__44277;
limit__$1 = G__44278;
parts = G__44279;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___44281 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___44281))
{var replacement_44282 = temp__4124__auto___44281;buffer.append([cljs.core.str(replacement_44282)].join(''));
} else
{buffer.append(ch);
}
{
var G__44283 = (index + 1);
index = G__44283;
continue;
}
}
