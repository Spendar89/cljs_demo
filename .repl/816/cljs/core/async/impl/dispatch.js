...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_64070 = 0;while(true){
var m_64071 = cljs.core.async.impl.dispatch.tasks.pop();if((m_64071 == null))
{} else
{m_64071.call(null);
if((count_64070 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__64072 = (count_64070 + 1);
count_64070 = G__64072;
continue;
}
} else
{}
