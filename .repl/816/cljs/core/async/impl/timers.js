...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__15549__auto__,writer__15550__auto__,opt__15551__auto__){return cljs.core._write.call(null,writer__15550__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_63979 = 0;while(true){
if((i_63979 < arr.length))
{(arr[i_63979] = null);
{
var G__63980 = (i_63979 + 1);
i_63979 = G__63980;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__15549__auto__,writer__15550__auto__,opt__15551__auto__){return cljs.core._write.call(null,writer__15550__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_63986 = (self__.level + 1);while(true){
if((i_63986 <= (new_level + 1)))
{(update[i_63986] = self__.header);
{
var G__63987 = (i_63986 + 1);
i_63986 = G__63987;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_63988 = 0;while(true){
if((i_63988 <= self__.level))
{var links_63989 = (update[i_63988]).forward;if(((links_63989[i_63988]) === x__$1))
{(links_63989[i_63988] = (x__$1.forward[i_63988]));
{
var G__63990 = (i_63988 + 1);
i_63988 = G__63990;
continue;
}
} else
{{
var G__63991 = (i_63988 + 1);
i_63988 = G__63991;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__14982__auto__ = (cljs.core.truth_((function (){var and__14970__auto__ = me;if(cljs.core.truth_(and__14970__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__14970__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__14982__auto__))
