...
{{
var G__61300 = cljs.core.pop.call(null,v__$1);
v__$1 = G__61300;
continue;
}
} else
...
{var pred__61304 = cljs.core._EQ_;var expr__61305 = limit;if(cljs.core.truth_(pred__61304.call(null,1,expr__61305)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__61304.call(null,2,expr__61305)))
...
var G__61307 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__61308 = (limit__$1 - 1);
var G__61309 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__61307;
limit__$1 = G__61308;
parts = G__61309;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___61311 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___61311))
{var replacement_61312 = temp__4124__auto___61311;buffer.append([cljs.core.str(replacement_61312)].join(''));
} else
{buffer.append(ch);
}
{
var G__61313 = (index + 1);
index = G__61313;
continue;
}
}
