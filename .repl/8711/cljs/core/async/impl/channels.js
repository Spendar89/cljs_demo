...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t43912 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t43912 = (function (val,box,meta43913){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t43912.cljs$lang$type = true;
cljs.core.async.impl.channels.t43912.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t43912";
cljs.core.async.impl.channels.t43912.cljs$lang$ctorPrWriter = (function (this__15673__auto__,writer__15674__auto__,opt__15675__auto__){return cljs.core._write.call(null,writer__15674__auto__,"cljs.core.async.impl.channels/t43912");
});
cljs.core.async.impl.channels.t43912.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t43912.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_43914){var self__ = this;
var _43914__$1 = this;return self__.meta43913;
});
cljs.core.async.impl.channels.t43912.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_43914,meta43913__$1){var self__ = this;
var _43914__$1 = this;return (new cljs.core.async.impl.channels.t43912(self__.val,self__.box,meta43913__$1));
});
cljs.core.async.impl.channels.__GT_t43912 = (function __GT_t43912(val__$1,box__$1,meta43913){return (new cljs.core.async.impl.channels.t43912(val__$1,box__$1,meta43913));
});
}
return (new cljs.core.async.impl.channels.t43912(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__15676__auto__,writer__15677__auto__,opts__15678__auto__){return cljs.core._write.call(null,writer__15677__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__15673__auto__,writer__15674__auto__,opt__15675__auto__){return cljs.core._write.call(null,writer__15674__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_43915 = self__.takes.pop();if((taker_43915 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_43915))
{var take_cb_43916 = cljs.core.async.impl.protocols.commit.call(null,taker_43915);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_43916,taker_43915){
return (function (){return take_cb_43916.call(null,null);
});})(take_cb_43916,taker_43915))
);
} else
{}
{
