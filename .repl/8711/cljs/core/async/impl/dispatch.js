...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_43906 = 0;while(true){
var m_43907 = cljs.core.async.impl.dispatch.tasks.pop();if((m_43907 == null))
{} else
{m_43907.call(null);
if((count_43906 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__43908 = (count_43906 + 1);
count_43906 = G__43908;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__15094__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__15094__auto__)
