...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__15673__auto__,writer__15674__auto__,opt__15675__auto__){return cljs.core._write.call(null,writer__15674__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_43815 = 0;while(true){
if((i_43815 < arr.length))
{(arr[i_43815] = null);
{
var G__43816 = (i_43815 + 1);
i_43815 = G__43816;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__15673__auto__,writer__15674__auto__,opt__15675__auto__){return cljs.core._write.call(null,writer__15674__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_43822 = (self__.level + 1);while(true){
if((i_43822 <= (new_level + 1)))
{(update[i_43822] = self__.header);
{
var G__43823 = (i_43822 + 1);
i_43822 = G__43823;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_43824 = 0;while(true){
if((i_43824 <= self__.level))
{var links_43825 = (update[i_43824]).forward;if(((links_43825[i_43824]) === x__$1))
{(links_43825[i_43824] = (x__$1.forward[i_43824]));
{
var G__43826 = (i_43824 + 1);
i_43824 = G__43826;
continue;
}
} else
{{
var G__43827 = (i_43824 + 1);
i_43824 = G__43827;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__15106__auto__ = (cljs.core.truth_((function (){var and__15094__auto__ = me;if(cljs.core.truth_(and__15094__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__15094__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__15106__auto__))
