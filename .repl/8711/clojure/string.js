...
{{
var G__43917 = cljs.core.pop.call(null,v__$1);
v__$1 = G__43917;
continue;
}
} else
...
{var pred__43921 = cljs.core._EQ_;var expr__43922 = limit;if(cljs.core.truth_(pred__43921.call(null,1,expr__43922)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__43921.call(null,2,expr__43922)))
...
var G__43924 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__43925 = (limit__$1 - 1);
var G__43926 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__43924;
limit__$1 = G__43925;
parts = G__43926;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___43928 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___43928))
{var replacement_43929 = temp__4124__auto___43928;buffer.append([cljs.core.str(replacement_43929)].join(''));
} else
{buffer.append(ch);
}
{
var G__43930 = (index + 1);
index = G__43930;
continue;
}
}
