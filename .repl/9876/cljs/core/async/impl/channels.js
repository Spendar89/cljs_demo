...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t36856 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t36856 = (function (val,box,meta36857){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t36856.cljs$lang$type = true;
cljs.core.async.impl.channels.t36856.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t36856";
cljs.core.async.impl.channels.t36856.cljs$lang$ctorPrWriter = (function (this__15549__auto__,writer__15550__auto__,opt__15551__auto__){return cljs.core._write.call(null,writer__15550__auto__,"cljs.core.async.impl.channels/t36856");
});
cljs.core.async.impl.channels.t36856.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t36856.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36858){var self__ = this;
var _36858__$1 = this;return self__.meta36857;
});
cljs.core.async.impl.channels.t36856.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36858,meta36857__$1){var self__ = this;
var _36858__$1 = this;return (new cljs.core.async.impl.channels.t36856(self__.val,self__.box,meta36857__$1));
});
cljs.core.async.impl.channels.__GT_t36856 = (function __GT_t36856(val__$1,box__$1,meta36857){return (new cljs.core.async.impl.channels.t36856(val__$1,box__$1,meta36857));
});
}
return (new cljs.core.async.impl.channels.t36856(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_36859 = self__.takes.pop();if((taker_36859 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_36859))
{var take_cb_36860 = cljs.core.async.impl.protocols.commit.call(null,taker_36859);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_36860,taker_36859){
return (function (){return take_cb_36860.call(null,null);
});})(take_cb_36860,taker_36859))
);
} else
{}
{
