...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_36850 = 0;while(true){
var m_36851 = cljs.core.async.impl.dispatch.tasks.pop();if((m_36851 == null))
{} else
{m_36851.call(null);
if((count_36850 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__36852 = (count_36850 + 1);
count_36850 = G__36852;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__14970__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__14970__auto__)
