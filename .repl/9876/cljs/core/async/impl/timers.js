...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_36759 = 0;while(true){
if((i_36759 < arr.length))
{(arr[i_36759] = null);
{
...
{var i_36766 = (self__.level + 1);while(true){
if((i_36766 <= (new_level + 1)))
{(update[i_36766] = self__.header);
{
var G__36767 = (i_36766 + 1);
i_36766 = G__36767;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_36768 = 0;while(true){
if((i_36768 <= self__.level))
{var links_36769 = (update[i_36768]).forward;if(((links_36769[i_36768]) === x__$1))
{(links_36769[i_36768] = (x__$1.forward[i_36768]));
{
var G__36770 = (i_36768 + 1);
i_36768 = G__36770;
continue;
}
} else
{{
var G__36771 = (i_36768 + 1);
i_36768 = G__36771;
continue;
}
}
