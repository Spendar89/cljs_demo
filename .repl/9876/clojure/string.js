...
{{
var G__34080 = cljs.core.pop.call(null,v__$1);
v__$1 = G__34080;
continue;
}
} else
...
{var pred__34084 = cljs.core._EQ_;var expr__34085 = limit;if(cljs.core.truth_(pred__34084.call(null,1,expr__34085)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__34084.call(null,2,expr__34085)))
...
var G__34087 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__34088 = (limit__$1 - 1);
var G__34089 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__34087;
limit__$1 = G__34088;
parts = G__34089;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___34091 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___34091))
{var replacement_34092 = temp__4124__auto___34091;buffer.append([cljs.core.str(replacement_34092)].join(''));
} else
{buffer.append(ch);
}
{
var G__34093 = (index + 1);
index = G__34093;
continue;
}
}
