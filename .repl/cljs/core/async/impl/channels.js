...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t29144 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t29144 = (function (val,box,meta29145){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t29144.cljs$lang$type = true;
cljs.core.async.impl.channels.t29144.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t29144";
cljs.core.async.impl.channels.t29144.cljs$lang$ctorPrWriter = (function (this__15549__auto__,writer__15550__auto__,opt__15551__auto__){return cljs.core._write.call(null,writer__15550__auto__,"cljs.core.async.impl.channels/t29144");
});
cljs.core.async.impl.channels.t29144.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t29144.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29146){var self__ = this;
var _29146__$1 = this;return self__.meta29145;
});
cljs.core.async.impl.channels.t29144.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29146,meta29145__$1){var self__ = this;
var _29146__$1 = this;return (new cljs.core.async.impl.channels.t29144(self__.val,self__.box,meta29145__$1));
});
cljs.core.async.impl.channels.__GT_t29144 = (function __GT_t29144(val__$1,box__$1,meta29145){return (new cljs.core.async.impl.channels.t29144(val__$1,box__$1,meta29145));
});
}
return (new cljs.core.async.impl.channels.t29144(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_29147 = self__.takes.pop();if((taker_29147 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_29147))
{var take_cb_29148 = cljs.core.async.impl.protocols.commit.call(null,taker_29147);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_29148,taker_29147){
return (function (){return take_cb_29148.call(null,null);
});})(take_cb_29148,taker_29147))
);
} else
{}
{
