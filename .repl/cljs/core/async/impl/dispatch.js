...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_29138 = 0;while(true){
var m_29139 = cljs.core.async.impl.dispatch.tasks.pop();if((m_29139 == null))
{} else
{m_29139.call(null);
if((count_29138 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__29140 = (count_29138 + 1);
count_29138 = G__29140;
continue;
}
} else
{}
