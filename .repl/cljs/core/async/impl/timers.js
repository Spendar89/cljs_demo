...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_29047 = 0;while(true){
if((i_29047 < arr.length))
{(arr[i_29047] = null);
{
...
{var i_29054 = (self__.level + 1);while(true){
if((i_29054 <= (new_level + 1)))
{(update[i_29054] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_29056 = 0;while(true){
if((i_29056 <= self__.level))
{var links_29057 = (update[i_29056]).forward;if(((links_29057[i_29056]) === x__$1))
{(links_29057[i_29056] = (x__$1.forward[i_29056]));
{
var G__29058 = (i_29056 + 1);
i_29056 = G__29058;
continue;
}
} else
{{
var G__29059 = (i_29056 + 1);
i_29056 = G__29059;
continue;
}
}
