...
{{
var G__26478 = cljs.core.pop.call(null,v__$1);
v__$1 = G__26478;
continue;
}
} else
...
{var pred__26482 = cljs.core._EQ_;var expr__26483 = limit;if(cljs.core.truth_(pred__26482.call(null,1,expr__26483)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__26482.call(null,2,expr__26483)))
...
var G__26485 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__26486 = (limit__$1 - 1);
var G__26487 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__26485;
limit__$1 = G__26486;
parts = G__26487;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___26489 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___26489))
{var replacement_26490 = temp__4124__auto___26489;buffer.append([cljs.core.str(replacement_26490)].join(''));
} else
{buffer.append(ch);
}
{
var G__26491 = (index + 1);
index = G__26491;
continue;
}
}
