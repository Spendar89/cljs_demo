...
sablono.util.ToString = (function (){var obj27415 = {};return obj27415;
})();
sablono.util.to_str = (function to_str(x){if((function (){var and__14970__auto__ = x;if(and__14970__auto__)
...
{var x__15609__auto__ = (((x == null))?null:x);return (function (){var or__14982__auto__ = (sablono.util.to_str[goog.typeOf(x__15609__auto__)]);if(or__14982__auto__)
{return or__14982__auto__;
} else
{var or__14982__auto____$1 = (sablono.util.to_str["_"]);if(or__14982__auto____$1)
...
sablono.util.ToURI = (function (){var obj27417 = {};return obj27417;
})();
sablono.util.to_uri = (function to_uri(x){if((function (){var and__14970__auto__ = x;if(and__14970__auto__)
...
{var x__15609__auto__ = (((x == null))?null:x);return (function (){var or__14982__auto__ = (sablono.util.to_uri[goog.typeOf(x__15609__auto__)]);if(or__14982__auto__)
{return or__14982__auto__;
} else
{var or__14982__auto____$1 = (sablono.util.to_uri["_"]);if(or__14982__auto____$1)
{return or__14982__auto____$1;
} else
...
as_str.cljs$lang$applyTo = (function (arglist__27418){
var xs = cljs.core.seq(arglist__27418);
...
{var vec__27420 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__27420,0,null);var words = cljs.core.nthnext.call(null,vec__27420,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
*/
sablono.util.camel_case_keys = (function camel_case_keys(m){var f = (function (p__27423){var vec__27424 = p__27423;var k = cljs.core.nth.call(null,vec__27424,0,null);var v = cljs.core.nth.call(null,vec__27424,1,null);if((k instanceof cljs.core.Keyword))
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__27425_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__27425_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__27425_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__27425_SHARP_))
{return p1__27425_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__27426){
var maps = cljs.core.seq(arglist__27426);
...
* CSS classes.
*/
sablono.util.match_tag = (function match_tag(s){var matches = cljs.core.re_seq.call(null,/[#.]?[^#.]+/,cljs.core.name.call(null,s));var vec__27430 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",1014018828),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):((new cljs.core.Keyword(null,"default","default",2558708147))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null):null)));var tag_name = cljs.core.nth.call(null,vec__27430,0,null);var names = cljs.core.nth.call(null,vec__27430,1,null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,(function (p1__27427_SHARP_){return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__27427_SHARP_));
}),names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,(function (p1__27428_SHARP_){return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__27428_SHARP_));
}),names)))], null);
});
/**
* Ensure an element vector is of the form [tag-name attrs content].
*/
sablono.util.normalize_element = (function normalize_element(p__27431){var vec__27434 = p__27431;var tag = cljs.core.nth.call(null,vec__27434,0,null);var content = cljs.core.nthnext.call(null,vec__27434,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__27435 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__27435,0,null);var id = cljs.core.nth.call(null,vec__27435,1,null);var class$ = cljs.core.nth.call(null,vec__27435,2,null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
...
goog.Uri.prototype.sablono$util$ToString$to_str$arity$1 = (function (x){var x__$1 = this;if(cljs.core.truth_((function (){var or__14982__auto__ = x__$1.hasDomain();if(cljs.core.truth_(or__14982__auto__))
{return or__14982__auto__;
} else
