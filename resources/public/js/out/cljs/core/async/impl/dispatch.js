...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_87677 = 0;while(true){
var m_87678 = cljs.core.async.impl.dispatch.tasks.pop();if((m_87678 == null))
{} else
{m_87678.call(null);
if((count_87677 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__87679 = (count_87677 + 1);
count_87677 = G__87679;
continue;
}
} else
{}
