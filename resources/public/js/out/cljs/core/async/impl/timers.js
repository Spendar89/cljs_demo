...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_87642 = 0;while(true){
if((i_87642 < arr.length))
{(arr[i_87642] = null);
{
var G__87643 = (i_87642 + 1);
i_87642 = G__87643;
continue;
}
} else
...
{var i_87649 = (self__.level + 1);while(true){
if((i_87649 <= (new_level + 1)))
{(update[i_87649] = self__.header);
{
var G__87650 = (i_87649 + 1);
i_87649 = G__87650;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_87651 = 0;while(true){
if((i_87651 <= self__.level))
{var links_87652 = (update[i_87651]).forward;if(((links_87652[i_87651]) === x__$1))
{(links_87652[i_87651] = (x__$1.forward[i_87651]));
{
var G__87653 = (i_87651 + 1);
i_87651 = G__87653;
continue;
}
} else
{{
var G__87654 = (i_87651 + 1);
i_87651 = G__87654;
continue;
}
}
