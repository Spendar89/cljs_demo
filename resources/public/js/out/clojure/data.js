...
{return cljs.core.reduce.call(null,(function (result,p__83887){var vec__83888 = p__83887;var k = cljs.core.nth.call(null,vec__83888,0,null);var v = cljs.core.nth.call(null,vec__83888,1,null);return cljs.core.assoc.call(null,result,k,v);
...
clojure.data.EqualityPartition = (function (){var obj83892 = {};return obj83892;
})();
clojure.data.equality_partition = (function equality_partition(x){if((function (){var and__3391__auto__ = x;if(and__3391__auto__)
...
{var x__4030__auto__ = (((x == null))?null:x);return (function (){var or__3403__auto__ = (clojure.data.equality_partition[goog.typeOf(x__4030__auto__)]);if(or__3403__auto__)
{return or__3403__auto__;
} else
{var or__3403__auto____$1 = (clojure.data.equality_partition["_"]);if(or__3403__auto____$1)
...
clojure.data.Diff = (function (){var obj83894 = {};return obj83894;
})();
clojure.data.diff_similar = (function diff_similar(a,b){if((function (){var and__3391__auto__ = a;if(and__3391__auto__)
...
{var x__4030__auto__ = (((a == null))?null:a);return (function (){var or__3403__auto__ = (clojure.data.diff_similar[goog.typeOf(x__4030__auto__)]);if(or__3403__auto__)
{return or__3403__auto__;
} else
{var or__3403__auto____$1 = (clojure.data.diff_similar["_"]);if(or__3403__auto____$1)
{return or__3403__auto____$1;
} else
...
(clojure.data.equality_partition["_"] = (function (x){if((function (){var G__83895 = x;if(G__83895)
{var bit__4053__auto__ = (G__83895.cljs$lang$protocol_mask$partition0$ & 1024);if((bit__4053__auto__) || (G__83895.cljs$core$IMap$))
{return true;
} else
{if((!G__83895.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__83895);
} else
{return false;
}
}
...
{if((function (){var G__83896 = x;if(G__83896)
{var bit__4053__auto__ = (G__83896.cljs$lang$protocol_mask$partition0$ & 4096);if((bit__4053__auto__) || (G__83896.cljs$core$ISet$))
{return true;
} else
{if((!G__83896.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__83896);
} else
{return false;
}
}
...
{if((function (){var G__83897 = x;if(G__83897)
{var bit__4053__auto__ = (G__83897.cljs$lang$protocol_mask$partition0$ & 16777216);if((bit__4053__auto__) || (G__83897.cljs$core$ISequential$))
{return true;
} else
{if((!G__83897.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__83897);
} else
{return false;
}
}
...
(clojure.data.diff_similar["_"] = (function (a,b){return (function (){var G__83898 = clojure.data.equality_partition.call(null,a);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"map","map",1014012110),G__83898))
{return clojure.data.diff_associative;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"sequential","sequential",849892465),G__83898))
{return clojure.data.diff_sequential;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"set","set",1014018004),G__83898))
{return clojure.data.diff_set;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"atom","atom",1016908995),G__83898))
