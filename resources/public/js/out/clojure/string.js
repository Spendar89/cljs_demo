...
{{
var G__84970 = cljs.core.pop.call(null,v__$1);
v__$1 = G__84970;
continue;
}
} else
...
{var pred__84974 = cljs.core._EQ_;var expr__84975 = limit;if(cljs.core.truth_(pred__84974.call(null,1,expr__84975)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__84974.call(null,2,expr__84975)))
...
var G__84977 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__84978 = (limit__$1 - 1);
var G__84979 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__84977;
limit__$1 = G__84978;
parts = G__84979;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___84981 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___84981))
{var replacement_84982 = temp__4090__auto___84981;buffer.append([cljs.core.str(replacement_84982)].join(''));
} else
{buffer.append(ch);
}
{
var G__84983 = (index + 1);
index = G__84983;
continue;
}
}
